...
public class PermissionController {
	...
	public ResponseData<List<PermissionResponse>> getAllRole() {
		return ResponseData.<List<PermissionResponse>>builder().message(ResponseMessage.GET_ALL_ROLE)
	...
	public ResponseData<PermissionResponse> createRole(@RequestBody PermissionRequest request) {
		return ResponseData.<PermissionResponse>builder().message(ResponseMessage.CREATE_ROLE)
