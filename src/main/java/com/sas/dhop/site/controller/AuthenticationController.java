...
public class AuthenticationController {
	...
	public ResponseData<AuthenticationResponse> oauthAuthenticate(@RequestParam("code") String code) {
		return ResponseData.<AuthenticationResponse>builder().message(ResponseMessage.AUTHENTICATION_LOGIN)
				.data(authenticationService.oauthLogin(code)).build();
	}

	@PostMapping("/reset-password")
	public ResponseData<AuthenticationResponse> resetPassword(@RequestBody ResetPasswordRequest request)
			throws ParseException, JOSEException {
		return ResponseData.<AuthenticationResponse>builder().message(ResponseMessage.RESET_PASSWORD)
				.data(authenticationService.resetPassword(request)).build();
	}
	...
	public ResponseData<AuthenticationResponse> otpResetPassword(@RequestBody VerifyOTPRequest request) {
		return ResponseData.<AuthenticationResponse>builder().message(ResponseMessage.OTP_RESET_PASSWORD)
				.data(authenticationService.verifyOTPResetPassword(request)).build();
	}
	...
	public ResponseData<AuthenticationResponse> verifyOTP(@RequestBody VerifyOTPRequest request) {
		return ResponseData.<AuthenticationResponse>builder()
				...
				.message(ResponseMessage.VERIFICATION_OTP_SUCCESS).build();
	}
	...
	public ResponseData<IntrospectResponse> introspect(@RequestBody IntrospectRequest request) {
		return ResponseData.<IntrospectResponse>builder().message(ResponseMessage.INTROSPECT_TOKEN)
	...
	public ResponseData<AuthenticationResponse> refresh(@RequestBody RefreshTokenRequest request)
			throws ParseException, JOSEException {
		return ResponseData.<AuthenticationResponse>builder().message(ResponseMessage.REFRESH_TOKEN)
