...
public class AreaServiceImpl implements AreaService {
  ...
  public AreaResponse createNewArea(AreaRequest areaRequest) {
    ...
    boolean isExists =
        areaRepository.existsByLocation(
            areaRequest.city().trim(), areaRequest.district().trim(), areaRequest.ward().trim());
  ...
  public AreaResponse updateArea(int areaId, AreaRequest areaRequest) {
    ...
    boolean isStaff =
        currentUser.getRoles().stream().anyMatch(role -> role.getName() == RoleName.STAFF);
