...
public class BookingFeedbackServiceImpl implements BookingFeedbackService {
  ...
  public List<BookingFeedbackResponse> getFeedbackByDancerId(Integer dancerId) {
    ...
    List<BookingFeedback> feedbacks =
        bookingFeedbackRepository.findAll().stream()
  ...
  @Override
  public BookingFeedbackResponse createBookingFeedback(
      BookingFeedbackRequest bookingFeebackRequest) {
