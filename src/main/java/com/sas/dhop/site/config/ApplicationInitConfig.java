    ...
    return args -> {
      ...
      if (userRepository.findByEmail("admin@gmail.com").isEmpty()) {
        ...
        for (int i = 0; i < 10; i++) {
          ...
          DanceType type =
              danceTypeRepository.save(DanceType.builder().type(fakerUS.job().title()).build());
          ...
          if (i % 2 == 0) {
            ...
            performanceRepository.save(
                Performance.builder().user(userWithRoleDancer).status(activeStatus).build());
          }
